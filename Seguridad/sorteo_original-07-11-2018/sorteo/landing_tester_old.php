...
$query_participantes_hoy2 = $db->prepare("SELECT * FROM lottery_emails WHERE date_add >= ? AND date_add <= ? AND id_lottery=? order by date_add desc");
$query_participantes_hoy2->execute(array(date('Y-m-d').' '.'00:00:00', date('Y-m-d H:i'),$id_sorteo,));
$dparticipantes_hoy = $query_participantes_hoy2->fetchAll(PDO::FETCH_ASSOC);

print_r("<br><br> Detalle Participantes de Hoy (Ordenado de mas reciente a más antiguo) <br><br>");
...
echo "<br><br><h1>Si algo falla recordad La dura vida del desarrollador y el tester 😂 </h1> <br><img style='width: 60%;' src='https://media1.tenor.com/images/7876350f0a51b6ef667c64b9aac7ac01/tenor.gif?itemid=8682110' />";
echo "<br><br><img style='width: 60%;' src='https://media1.tenor.com/images/4bdd05191c9d1c5b58ab48c4784be5d6/tenor.gif?itemid=8487352' />";

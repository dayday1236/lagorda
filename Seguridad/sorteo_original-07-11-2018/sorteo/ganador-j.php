                ...
                <div class="guide guide col-xs-12 col-md-12 col-lg-12">
                    ...
                    <span class="titulo text-center">
                        ...
                        <p class="row texto-mediano-grande texto-producto">
                            HAS GANDO UN CAMISÓN PICARDÍAS <br>EN RASO ROJO BURDEOS 
                        </p>
                    </span>                     
                    <div class="row producto-img">
                        <img width="224" style="width: 286px;" alt="Pijama Roja" src="img/pijama-roja-frente.png" />
                        <img width="224" style="width: 286px; margin-left: 21px;" alt="Pijama Roja" src="img/pijama-roja-atras.png" />
                    </div>
                    ...
                    <form class="row" id="mc-form">                                                  
                        <div class="" style="margin: 0 auto; width: 70%;">
                            <a style="margin: 0 auto;" class="btn btn-secondary btn-block boton texto-mediano-mediano" href="<?php echo $url_tienda ?>"><span class="">VISITA NUESTRA WEB</span></a>
                        </div>                        
                    </form>

        ...
        <div class="page">                        
            ...
            <div class="contenedor">
                <div class="guide guide col-xs-12 col-md-12 col-lg-12">
                    ...
                    <div class="row texto-mediano-mediano por-participar">
                        <p>Pero solo por participar tienes un <br>descuento exclusivo de 10€ 😍</p>
                    </div>
                    <div class="row producto-img">
                        <img width="224" style="width: 224px;" alt="Descuento" src="img/10-dto.png" />
                    </div>
                    <div class="row texto-mediano-mediano instrucciones">
                        <p>Canjea el código descuento CURVY10E en nuestra<br>tienda en Amazon y podrás disfrutar de 10€ de<br> descuento.</p>
                    </div>
                    ...
                    <form class="row" id="mc-form">                          
                        <div class="row">
                            <div class="col-md-12 col-xs-12" style="">
                                <a href="<?php echo $url_tienda ?>"><button class="btn btn-secondary btn-block boton texto-mediano-mediano "  type="button"><span class="">VER TODO EL CATÁLOGO</span></button></a>
                            </div>
                        </div>
                    </form>

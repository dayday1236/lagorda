                ...
                <div class="guide guide col-xs-12 col-md-12 col-lg-12">
                    ...
                    <span class="titulo text-center">
                        ...
                        <p class="row texto-mediano-grande texto-producto">
                            HAS GANDO UN CAMISÓN PICARDÍAS <br>EN RASO NEGRO
                        </p>
                    </span>                     
                    <div class="row producto-img">
                        <img width="224" style="width: 286px;" alt="Pijama Roja" src="img/pijama-negra-frente.png" />
                        <img width="224" style="width: 286px; margin-left: 21px;" alt="Pijama Roja" src="img/pijama-negra-atras.png" />
                    </div>
